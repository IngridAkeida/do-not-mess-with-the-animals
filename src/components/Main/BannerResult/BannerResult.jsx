            ...
            <div className='flex flex-col'>
              <div className='flex flex-wrap gap-2 items-center bg-dark-primary-a40 bg-opacity-85 py-2'>
                ...
                <div className='flex items-center'>
                  <div
                    className={`transition-opacity duration-300 hover:cursor-pointer
                    ${showModalVideo ? 'opacity-0' : 'opacity-100'}`}
                    onClick={handleModalVideoClick}
                  >
                    <RiPlayLargeFill className='pl-2 text-3xl sm:text-4xl text-dark-primary-a10 transition-all hover:text-dark-primary-a20' />
                  </div>
                </div>
              </div>
              <div className='flex p-4 relative flex-wrap'>
                      ...
                      <div className='flex gap-2 flex-wrap'>
                        {item.credits.cast.slice(0, 4).map((cast, index) => (
                          <div key={index} className=''>
                            <div className=''>
                              <Image
                                className='rounded-md h-32 w-auto sm:h-44'

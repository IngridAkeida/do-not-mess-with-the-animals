...
const Banner = () => {
  ...
  return (
    <div className='text-center px-2 h-96 bg-amber-700 flex flex-col items-center justify-center gap-4 sm:px-10 rounded-b-md'>
      ...
      <div className='text-base sm:text-2xl relative m-2'>
        <input 
          ...
          />
        <button 
        className='p-2 sm:p-4 bg-amber-800 hover:bg-amber-900 rounded-xl absolute right-0 
